const Details = () => {
  return (
    <>
      <div className="flex justify-center items-center mt-0 flex-row max-md:flex-col gap-12">
        ...
        <div className="flex-1 text-2xl font-thin text-white max-md:mt-2 max-md:text-4xl flex flex-col justify-center max-md:w-full">
          ...
          <div className=" md:mr-[70px] max-md:text-center max-md: mt-12">
            <div className="max-md:text-left mt-4 font-montserrat tracking-widest text-3xl font-light">
