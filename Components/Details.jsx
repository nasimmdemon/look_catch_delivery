const Details = () => {
  return (
    <>
      <div class="flex justify-center items-center mt-10 flex-row max-md:flex-col gap-12">
        <div class="flex-1 max-md:text-center md:w-[49%] ">
          <p class="mr-4 font-poppins font-light text-4xl text-white max-md:text-left max-md:pl-20">
        ...
        <div class="flex-1 text-2xl font-thin text-white max-md:mt-5 max-md:text-4xl flex flex-col justify-center max-md:w-full">
          <div class="border-t border-gray-400 w-full md:hidden max-md:mt-4"></div>
