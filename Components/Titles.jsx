const Titles = () => {
  return (
    ...
    >
      <div className=" border-r-[0.1px]  border-white flex justify-center items-center gap-2 max-md:hidden">
      ...
      <div className=" md:hidden flex flex-col justify-center items-start gap-2 ">
        ...
        <span className="text-white text-5xl font-montserrat font-extralight flex tracking-widest items-center">
          <div className="flex font-bold justify-center items-center">
            box <div className="h-8 w-8 border ml-2 mt-2 rounded-lg"></div>
          </div>
